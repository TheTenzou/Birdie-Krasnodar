            ...
            <div className="col-lg-4">
              <div className="mx-auto testimonial-item mb-5 mb-lg-0">
                ...
                >
                  ...
                  мой друг посоветовал Birdie для поиска новых ощущений. Я была
                  в полном восторге от своей поездки, это был лучший уикэнд. Я
                  надеюсь на скорое возвращение в любимые места.
                </p>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="mx-auto testimonial-item mb-5 mb-lg-0">
                ...
                <p className="font-weight-light mb-0">
                  ...
                  мир вкусной еды, когда я уже совсем потерял надежду на вкусное
                  питание в данном городе.
                </p>
              </div>
            </div>
            <div className="col-lg-4">
