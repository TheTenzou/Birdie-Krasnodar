    ...
    return (
      <div>
        ...
        <header
          ...
          style={{
            background: 'url("assets/img/Diner1.jpg")no-repeat center center',
        ...
        >
          ...
          <div className="container">
            <div className="row">
              <div
                className="col-md-4"
                style={{ height: 300, paddingBottom: "40px" }}
              >
                <div />
                ...
                >
                  Где найти самых приятную кампанию для беседы. Рассказываем в
                  нашем постоянном блоге.
                </p>
              </div>
              <div
                className="col-md-4 offset-xl-0"
                style={{ height: 300, paddingBottom: "40px" }}
              >
                <div />
                ...
                >
                  Выберите наиболее подходящий вам формат еды и найдите место
                  поблизости.
                </p>
              </div>
              <div className="col-md-4" style={{ height: 300 }}>
                ...
                >
                  Узнайте, где подают лучшее пиво в Краснодаре.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="showcase">
          ...
          >
            <h2 style={{ width: "225px", paddingTop: "40px" }}>
              Куда сходить?
            </h2>
            <p
            ...
            >
              ...
              комментарий по поводу всего: начиная от интерьера, заканчивая едой
              и её качеством. Основа нашей философии — страсть к открытию
              чего-то нового и необычного. Мы предлагаем Вам самый различные
              форматы еды и заведений на любой вкус.
            </p>
            <a
          ...
          <div className="container-fluid p-0">
            ...
            <div className="row no-gutters">
              <div
                ...
                style={{
                  background: 'url("assets/img/Screenshot_6.png") center'
                }}
              >
                <span />
              </div>
              <div className="col-lg-6 my-auto order-lg-1 showcase-text">
                ...
                <p
                  ...
                  style={{ fontFamily: "Roboto, sans-serif" }}
                >
                  Тут можно подправить размер фото.
                  <br />
                  Контент по какому-то кафе.&nbsp;
                  <br />
                  Контент по какому-то кафе.&nbsp;
                  ...
                  Контент по какому-то кафе.&nbsp;
                  <br />
                  Контент по какому-то кафе.&nbsp;&nbsp;Это широкое
                  поле!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!Это
                  широкое поле!
                  <br />
                  Контент по какому-то кафе.&nbsp;
                  ...
                  &nbsp;Это широкое
                  поле!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!Это
                  широкое поле! Контент по какому-то кафе.&nbsp;
                  <br />
                </p>
                <a
        ...
        >
          <div className="container">
            <h1 className="mb-5" style={{ fontFamily: "Roboto, sans-serif" }}>
              Отзывы
            </h1>
            <p
              style={{
            ...
            >
              Мы любим делиться впечатлениями и реальными отзывами.
              Присоединяйтесь!
            </p>
            <div className="row">
              <div className="col-lg-4">
                <div className="mx-auto testimonial-item mb-5 mb-lg-0">
                  ...
                  <h5 style={{ fontFamily: "Roboto, sans-serif" }}>
                    <strong>Анна1994</strong>
                  </h5>
                  <p
                    className="font-weight-light mb-0"
                    style={{ fontFamily: "Roboto, sans-serif" }}
                  >
                    Мне давно нужен был отдых. Местом я выбрала Краснодар. Один
                    мой друг посоветовал Birdie для поиска новых ощущений. Я
                    была в полном восторге от своей поездки, это был лучший
                    уикэнд. Я надеюсь на скорое возвращение в любимые места.
                  </p>
                </div>
              </div>
              <div className="col-lg-4">
                <div className="mx-auto testimonial-item mb-5 mb-lg-0">
                  ...
                  <p className="font-weight-light mb-0">
                    Спасибо команде сайта за новые возможности. Я живу в
                    Краснодаре уже более 10 лет, но был слеп и не заходил в эти
                    маленькие закутки на главных улицах. Birdie открыл для меня
                    мир вкусной еды, когда я уже совсем потерял надежду на
                    вкусное питание в данном городе.
                  </p>
                </div>
              </div>
              <div className="col-lg-4">
                <div className="mx-auto testimonial-item mb-5 mb-lg-0">
                  ...
                  <h5>CoffeePro</h5>
                  <p className="font-weight-light mb-0">
                    Я домашний бариста, который всегда мечтал о месте, в которое
                    могу заходить за отличным кофе перед работой в офисе. Birdie
                    дал мне такую замечательную возможность.
                  </p>
                </div>
              </div>
            </div>
