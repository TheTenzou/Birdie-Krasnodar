...
from ..serializers import PriceBracketSerializer, FoodTypeSerializer, AddressSerializer
...
class RestaurantDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Restaurant
        fields = ['id', 'description', 'food_type', 'price_bracket', 'card_picture', 'rating', 'address']
